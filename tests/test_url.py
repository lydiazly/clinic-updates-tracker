...
@pytest.mark.parametrize("full_url, full_url_expected", [
    [get_full_url("https://base_url", '?', {'arg1': 'val1'}), "https://base_url?arg1=val1"],
    [get_full_url("https://base_url", '?', {'arg1': 'val1', 'arg2': 'val2'}), "https://base_url?arg1=val1&arg2=val2"],
    [get_full_url("https://base_url", '/', "sub_path"), "https://base_url/sub_path"],
    [get_full_url("https://base_url", '?', "sub_path"), "https://base_url/sub_path"],
])
